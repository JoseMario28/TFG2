...
public class ImagenesFirebase {
    ...
    public static void subirFoto(final FotoStatus fotoStatus, String product_name, String product_price, ImageView img_add_foto) {
        ...
        StorageReference foto2Ref = storageRef.child(product_name+"/"+String.valueOf(product_price)+".png");
    ...
    public void descargarFoto(final FotoStatus fotoStatus, String foto) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReference();
    ...
    public void borrarFoto(final FotoStatus fotoStatus, String foto) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReference();
        StorageReference islandRef = storageRef.child(foto);
